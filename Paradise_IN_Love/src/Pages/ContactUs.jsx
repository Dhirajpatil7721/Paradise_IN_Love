...
const ContactUs = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-pink-50 mt-10">
      {/* Hero Section */}
      <section className="relative py-12 md:py-16 bg-pink-100">
        <div className="absolute inset-0 bg-gradient-to-r from-pink-200 to-pink-100 opacity-30"></div>
        <div className="container mx-auto px-4 sm:px-6 relative z-10 text-center">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="text-lg font-semibold text-gray-800 mb-1">Our Location</h4>
                    <a
                      href="https://www.google.com/maps?q=1154/55+Kasba+peth+behind+Sattoti+Police+station+near+Laxmi+Journal+Store"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-pink-500 hover:underline"
                    >
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="text-lg font-semibold text-gray-800 mb-1">Phone Number</h4>
                    <p className="text-gray-600">
                      <a href="tel:+919595455123" className="text-pink-500 hover:underline">+91 9595455123</a>
                    </p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="flex gap-3 flex-wrap">
                    {socialLinks.map(({ icon, label, url, color }, i) => (
                      <a
                        key={i}
                        href={url}
                        target="_blank"
