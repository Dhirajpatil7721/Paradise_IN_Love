...
const Anarkali = () => {
  ...
  return (
    <div className='mt-20'>
      <ToastContainer />
<h1 className="text-3xl font-bold text-center text-indigo-700 mb-2">Anarkali Collection</h1>
      <p className="text-center text-gray-600 max-w-2xl mx-auto mb-8">
        Explore our elegant collection of Anarkalis, designed to bring grace and charm to every occasion.
        From classic traditional styles to modern festive wear, find the perfect Anarkali to express your style.
      </p>
