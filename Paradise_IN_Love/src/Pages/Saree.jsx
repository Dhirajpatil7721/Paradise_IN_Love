    ...
    const fetchProductsByCategory = async () => {
      try {
        const response = await fetch('http://localhost:8080/api/product/get-pruduct-by-category-and-subcategory', {
          ...
          body: JSON.stringify({
            categoryId: ['683ec8f1da32e0d2140a5ab1'],
            subCategoryId: ['683ecce0da32e0d2140a5ac7', '683ecd17da32e0d2140a5ac9'],
            page: 1,
            limit: 12
          }),
        });
...
<h1 className="text-3xl font-bold text-center text-red-600 mb-2">Saree Collection</h1>

{/* Description */}
<p className="text-center text-gray-600 max-w-2xl mx-auto mb-8">
  Discover our timeless saree collection, where tradition meets elegance. 
  From graceful silk weaves to trendy printed styles, find the saree that celebrates your beauty and heritage.
</p>
